(function () {
    ...
    var score = {
        ...
        init: function () {
            ...
            this.mouseImg.src = imgs.mouseIcon;
            this.resultSpan = document.getElementById('mouses');
            this.resetPosition();
        },

        resetPosition: function() {
            this.initX = canvas.element.width / 2 + 200;
            this.initY = -50;
        },
        ...
        draw: function (context) {
            ...
            for (var i = 0; i < this.result; i++) {
                ...
                if (i % 4 == 0) {
                    context.beginPath();
                    context.moveTo(this.initX, this.y + 30);
                    context.lineTo(this.initX + 30 * 4, this.y + 10);
                    context.lineWidth = 3;
                    context.strokeStyle = colors.red1;
                    context.stroke();
                    context.closePath();
                    this.y += 60;
                    this.x = this.initX;
                }
                context.drawImage(this.mouseImg, this.x, this.y, 30, 60);
            }
        },
        ...
        show: function () {
            ...
            this.resultSpan.innerHTML = score.result + "";
